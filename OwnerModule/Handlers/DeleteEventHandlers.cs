...
{
    public async Task Handle(DeleteVehicleEvent @event, MediatorContext context, CancellationToken cancellationToken)
    {
    ...
    public async Task Handle(DeletePersonEvent @event, MediatorContext context, CancellationToken cancellationToken)
    {
